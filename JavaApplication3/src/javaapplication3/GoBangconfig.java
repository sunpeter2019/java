...
public interface GoBangconfig {
	...
	Image LOGINPICTURE2= new ImageIcon("pic\\LoginPicture2.png").getImage();	//这里不能用ImageIcon 
	...
	ImageIcon LOSEBUTTON = new ImageIcon("pic\\LoseButton.png");   //图标类
	ImageIcon BATTLEBUTTON1 = new ImageIcon("pic\\Battle1.png");
	ImageIcon BATTLEBUTTON2 = new ImageIcon("pic\\Battle2.png");
	ImageIcon USERPICTURE = new ImageIcon("pic\\UserPicture.jpg");
