...
public class LoginUI extends JFrame implements GoBangconfig{
	...
	public void initUI(){
		...
		JButton buttonLogin=new JButton("进入游戏界面",LOGINBUTTON); //JButton(String text, Icon icon)  Creates a button with initial text and an icon.
	...
	public void paint(Graphics g){
		super.paint(g);
		g.drawImage(LOGINPICTURE2, 0, 0,this.getWidth(), this.getHeight(), this);
	}
	//主函数入口
